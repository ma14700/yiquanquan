  ...
  <div>
    <div class="indenting">
      ...
      <div class="indenting-content">
        ...
        <div class="indenting-p">服务地址：{{orderList.orderCity}}</div>
        <div class="indenting-p">服务时间：{{orderList.modifyTime | date}}</div>
        <div class="indenting-p">下单时间：{{orderList.createTime | date}}</div>
      </div>
      <div class="indenting-combodetail">
        <div class="indenting-combodetail-head" @click="mealDetail()">套餐详情<span><i class="iconfont " :class="[mealdetail?'icon-smallxiangyou':'icon-arrow_down']"></i></span></div>
    ...
    export default {
        ...
        methods:{
            orderData(){
                ...
                if(this.$route.query.id){
                    ...
                    this.$http.get('/api/order/detail?id='+orderId).then(res=>{
                        ...
                        this.anotherPay = this.orderList.orderTotalFee - this.orderList.orderPromiseMoney;
                        this.mealData();
                    })
                }
            },
            ...
            decorating(){
                ...
                this.$router.push({ path: '/grabsingle/orderStatus', query: { id:this.urlId,status:'decoration-end' } })
            },
            decoratequering(){
            ...
            decoratequery(){
              this.popupVisible = false;
               this.$router.push({ path: '/grabsingle/completeindent' })
            },
            mealDetail(){
