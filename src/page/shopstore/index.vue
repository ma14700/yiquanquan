<template>
  <div class="shop">
    ...
    <router-link to="Qsearch" tag="div" class="qsearch-input fixed">
        <div class="qsearch-input-content">请输入关键词 <span><i class="iconfont icon-sousuo1"></i></span></div>
    </router-link>
    <!--搜素框  end-->
    ...
    <div class="youlike floor">
      ...
      <div class="swiper-container">
        ...
        <v-loadmore  :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" :auto-fill="false" ref="loadmore">  
          <ul class="taocan">
            <li :key="index" v-for="(item,index) in packageDataList" @click.stop="goPackageDetail(item.id)" v-if="item.name">
            <div class="img-box">
              <img v-lazy="item.mainImg" alt="">
            </div>
            <div class="text">
    ...
    goGooddetail(id) {
     ...
     loadTop:function() { //组件提供的下拉触发方法  
      ...
      loadPageList:function (){  
          // 查询数据 
        this.$http.post('api/partypkg/partylist',this.searchCondition).then(res=>{
        ...
        console.log(this.searchCondition)
         this.$http.post('/api/partypkg/partylist',this.searchCondition).then(res=>{
            if(res.data.length == 0){
              ...
              this.packageDataList = this.packageDataList.concat(res.data);
            }
         })  
      }, 
  },
